    ...
    <div id="main_container">
        ...
        <div id="main_content">
            ...
            <div class="discColumn2">
                <!--<div class="small_title">Discussions</div> -->
                <form id="form1" runat="server">
                <div style="OVERFLOW:auto;HEIGHT:330px">
                       <asp:DataGrid ID="DataGrid1" runat="server"  Width="621px" CellPadding="4" GridLines="Vertical" ForeColor="#333333">
                        ...
                        <div id="formview" runat="server">
                            <table>
                               <tr>
                                    <td>Notice: </td>
                                    <td><asp:TextBox ID="txtNotice" runat="server"/></td>
                                </tr>
                                <tr>
                                    <td>Description:</td>
                                    <td><asp:TextBox ID="txtDescription" runat="server" Columns="50" Rows="4" 
